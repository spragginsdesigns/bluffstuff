				...
				<div className="p-5">
					...
					<div className="flex gap-2 mt-3">
						<button
							...
							className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs text-gray-400 hover:text-white bg-gray-700/40 hover:bg-gray-700/70 border border-gray-600/30 hover:border-gray-500/50 transition-all duration-200"
						>
